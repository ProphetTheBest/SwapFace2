package com.example.faceswapapp.ui.sticker
                ...
                Column(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.padding(vertical = 2.dp)) {
                        ...
                        Slider(
                            ...
                            onValueChange = { onUpdateSticker(it, null, null, null) },
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.padding(vertical = 2.dp)) {
                        ...
                        Slider(
                            ...
                            onValueChange = { onUpdateSticker(null, it, null, null) },
                            valueRange = -200f..200f,
                            modifier = Modifier.weight(1f).padding(horizontal = 4.dp)
                        )
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.padding(vertical = 2.dp)) {
                        ...
                        Slider(
                            ...
                            onValueChange = { onUpdateSticker(null, null, it, null) },
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.padding(vertical = 2.dp)) {
                        ...
                        Slider(
                            ...
                            onValueChange = { onUpdateSticker(null, null, null, it) },
